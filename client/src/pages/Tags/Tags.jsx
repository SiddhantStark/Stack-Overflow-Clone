  ...
  return (
    <div className="home-container-1">
      ...
      <div className="home-container-2">
        ...
        <p className="tags-p"> A tag is a keyword or label that categorizes 
                        your question with other, similar questions. </p>
        <p className="tags-p">  Using the right tags makes it easier for others
                        to find and answer your question. </p>
